            ...
            agentPanel={voiceMode === "agent" && !activeThread ? (
              ...
              >
                ...
                <VoiceAgent
                  ...
                  visualSettings={resolvedVisualSettings}
                />
                <div className={agentOverlayMode === "immersive" ? "absolute right-4 top-[max(var(--mobile-safe-top),1rem)] z-10 flex gap-2 sm:right-6" : "absolute right-2 top-2 flex items-center gap-1"}>
                  <button
                    type="button"
